...
class Camera {
    public:
        ...
        KdTree* renderPhotonMap(std::vector<Model*> &models, std::vector<Light> &lights, int iterations, float materialAbsorbProbability);
        Camera();
    ...
    private:
        ...
        glm::vec3 lightSurface(glm::vec3 &albedo, glm::vec3 &rayDir, glm::vec3 &normal, glm::vec3 &lightDir, glm::vec3 &lightIntensity);
