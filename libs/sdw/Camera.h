...
class Camera {
    public:
        ...
        KdTree* renderPhotonMap(std::vector<Model*> &models, std::vector<Light> &lights, int iterations, float reflectMultiplier, glm::vec3 &biasPosition, float biasAmount, float intensity);
        Camera();
